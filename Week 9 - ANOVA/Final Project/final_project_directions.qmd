...
Specifically, you should remove the explanatory variable with the **largest** p-value, even if _both_ variables have p-values larger than your chosen $\alpha$ level.
:::
...
**If you failed to reject $H_0$ for your one-way ANOVA model, your next step is to fit a mean only model (one mean for _every_ observation).**
