...
I value diversity, inclusion and equity in this (and every) class. I hold the fundamental belief that [**everyone**]{.underline} is fully capable of learning and doing statistics. There is more than one way to address a statistical problem, and our learning will be richer by being open to different ideas, rejecting stereotypes, and being aware of---in order to minimize---our biases. I look forward to getting to know you all as individuals and as a learning community.
