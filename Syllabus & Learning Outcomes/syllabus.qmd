...
![Çetinkaya-Rundel and Hardin, **Introduction to Modern Statistics**. <https://openintro-ims.netlify.app/>](course images/ims.png)
...
::: {.column width="45%"}
![Ismay & Kim, **Modern Dive: Statistical Inference via Data Science**. <https://moderndive.com>](course images/modern_dive_cover.png)
:::
:::
...
![`R` is the statistical software we will be using in this course (<https://cran.r-project.org/>)](course images/R.jpeg){width="50%"}
:::
...
::: {.column width="30%"}
![For questions of general interest, such as course clarifications or conceptual questions, please use the Class Discord Server. Refer to the Day One Class Setup materials for more information on how to effectively use this server.](course images/discord.jpeg){width="50%"}
:::
:::
...
documents. The individual assigned as the Report Manager (described below) will
submit the team's completed Lab assignment by **Sunday at midnight.**
