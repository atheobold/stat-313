...
**Times:** 
- Section 01: M, T, W, R 8:10-9:00am
- Section 02: M, T, W, R 9:10-10:00am
...
<https://moderndive.com>](course images/modern_dive.png){width=40%} 
...
and lab assignments. We will be walking through this in the first week of lab! 
...
- Canvas will be used for homework, quizzes, lab assignments, and group
projects.

### Course Discord:

For questions of general interest, such as course clarifications or conceptual
questions, please use the [Class Discord Server (link)](). Refer to the Day One
Class Setup materials for more information on how to effectively use this server.
...
- Create thoughtful single variable, two variable, and multi variable data
...
```{r, out.width = '500%', out.height = "500%", fig.align = 'center', eval = FALSE}
knitr::include_graphics('images/individual_flow.jpeg')
```

**Group Expectations**

```{r, out.width = '100%', fig.align = 'center', eval = FALSE}
knitr::include_graphics('images/group_flow.jpeg')
```
...
that week. These weekly summaries of your conceptual understanding are due on 
Fridays at 5:00pm. 
...
for you to work through the tutorial for the week, thus the tutorials should be
started early! 
...
the week, however this time will not be sufficient to complete the assignments. Therefore, every group is expected to meet for at least 2-hours outside of
class. 

If you are not in attendance for more than *one* of your team meetings that 
week, you will be expected to complete that week's assignment on your own. 

My hope is that each member of the group looks over the week's assignment on
Monday while reading the week's chapter. Then, each member should have some 
...
problems between course meetings. Between the Thursday meeting and the Sunday deadline, the manager is responsible for scheduling additional meetings, so that
the editor is able to submit the assignment on time. 
...
| Complete weekly quiz    | Discuss concepts prior to quiz | 
| Complete practice problems from textbook | Discuss practice problems | 
| Complete practice activity | Discuss practice activity    | 
| Complete think out loud recording | Practice talking through your ideas | 
...
This class is organized into ___ units.

### Unit 1: Why Statistics? (Weeks 1 & 2)

This unit will walk through chapters 1 through 3 of *Introduction to Modern 
Statistics* and chapter 1 in *Modern Dive*. 

### Unit 2: Exploratory Data Analysis (Weeks 3 & 4)

This unit will walk through chapters 4 through 6 of *Introduction to Modern 
Statistics* and chapters 2 through 4 of *Modern Dive*. 

### Unit 3: Regression Modeling (Weeks 5 & 6)

This unit will walk through chapters 7 and 8 in *Introduction to Modern 
Statistics* and chapters 5 and 6 in *Modern Dive*. 
...
walk through chapters 11 through 14 in *Introduction to Modern Statistics*, 
...
### Unit 6: ANOVA an boring case of Regression (Week 10)

This unit will walk through chapter 22 in *Introduction to Modern 
Statistics*. 
