...
I am available for individual appointments on Tuesdays and Thursdays outside of
...
- Students will be able to identify, describe, and contrast different study 
designs:
...
multiple linear regression models using both quantitative and categorical 
predictor variables.
