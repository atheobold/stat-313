...
This class is organized into six units, each exploring a different statistical 
method. The skills learned at the beginning of the course will carry throughout
the remainder of the course. I hope that you are able to see the connections 
between the topics of the different units, since they are all part of one big 
family -- the regression family!

### Unit 1: Why Statistics? (Week 1)
...
(historically) statistics has been used to make inferences.  

Reading: Chapters 1 and 2 in *Introduction to Modern Statistics*, with 
additional articles

### Unit 2: Exploratory Data Analysis (Weeks 2 through 4)
