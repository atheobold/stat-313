...
<!-- This is a comment in the report, notice when you knit this text will not appear!  -->
<!-- To make a comment, highlight the line you want to comment and hit Control + Shift + C (at the same time) or click on the "Code" dropdown menu and select "Comment/Uncomment lines".  -->
...
1. (b) Are there categorical variables in the dataset? If so, what are their names?  
<!-- Your response goes below this line! -->
