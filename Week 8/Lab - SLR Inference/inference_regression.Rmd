...
knitr::opts_chunk$set(eval = TRUE,
                      ...
                      fig.height = 4)
set.seed(1234)
## This is used for your simulations to have the same p-value and confidence interval, instead of changing everytime you knit! Please keep this in your document! 
```
