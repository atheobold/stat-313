---
title: "Lab 4: Confidence Intervals for Water Temperature and Latitude"
...
**2. Create a scatterplot modeling the relationship between latitude (explanatory) and water temperature (response).** *Don't forget to add descriptive axis labels!*
