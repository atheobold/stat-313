---
title: "Lab 4: Confidence Intervals and "
...
__1. Fill in the code below to create a new dataset called `pie_crab_clean` which has 13 observations -- one per latitude / marsh.__
...
__2. Create a scatterplot modeling the relationship between latitude (explanatory) and water temperature (response).__ 
...
__3. Describe the relationship you see in the scatterplot. Be sure to address the four aspects we discussed in class: form, direction, strength, and unusual points!__
...
__4. Use the `get_correlation()` function to calculate the correlation between the water temperature and latitude.__
...
__5. Fill in the code below to calculate the slope for the relationship between the water temperature (response) and latitude (explanatory).__
...
__6. Fill in the code to generate 500 bootstrap slope statistics (from 500 bootstrap resamples).__
...
Alright, now that we have the bootstrap slope statistics, let's see what it looks
like! Let's use the `visualize()` function (not `ggplot()`!) to make a quick visualization of the statistics you calculated above. 

__7. Use the `visualize()` function to create a simple histogram of your 500 bootstrap statistics.__
...
So, I think this could be a great instance to use an 85% confidence interval. 

__8. Use the `get_confidence_interval()` function to find the 85% confidence interval from your bootstrap distribution, using the percentile method!__
...
__9. Interpret the confidence interval you obtained in #8. Make sure to include the context of the data!__

*We are 95% confident that the slope of the relationship between water temperature and latitude for __all__ marshes along the eastern coast of the US is between -0.864 and -0.669.*
...
__10. Use the `get_confidence_interval()` function to find the 85% confidence interval from your bootstrap distribution, using the SE method!__
...
__11. How do your confidence intervals compare? Why do you believe they are similar or different?__
...
__11. Based on the information given, how do you feel about the assumption a bootstrap distribution makes about the original sample? What issues do you believe might prevent this assumption being appropriate?)__
