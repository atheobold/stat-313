...
Score   | Demonstration
--------|--------------
4       | __Excellent__ -- Outstanding ability to articulate the concepts covered in the exam, with comprehensive and thoughtful understanding of the content of the assessment. If if any errors occur, and do not cloud the overall understanding of the content. 
...
the first question comes from the "linear models" bank and the second question 
comes from the "other topics" bank. Note that the "linear models" question is 
weighed more heavily than the "other topics" question. 
