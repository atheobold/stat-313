...
::: {.callout-tip}
The statistical model you fit in the next section depends on what you see in your visualization. For example, if there is little evidence that the slopes are different, you **should not** state you will use an interaction model to model the relationship between your variables. 
:::
...
- Interpret __in the context of the data__ the coefficients from the regression equation. 
