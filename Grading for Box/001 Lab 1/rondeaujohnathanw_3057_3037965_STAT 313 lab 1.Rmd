...
Because you did not submit an HTML file with your assignment 10% is being deducted from your assignment grade. In the future, please be sure to upload **both** a Rmd file **and** a knitted HTML file. 
...
The data matrix is made up of 32,735 flights.
...
Yes, there are categorical variables in the data set.  Carrier which is chr, Origin is chr 
...
As the histogram binwidth increases, the bars get much wider and more concentrated at 0 it appears.  In the 150 binwidth, values seem to be obscured.  Along with the binwidth 15, it seems that there is a very large numbers at 0.  Overall, I feel that 30 binwidth is the best representation.
...
I think a scatterplot or pie chart could have been produced.  I feel that both would be better options, with the scatterplot being the best.  The benefit of a histogram is graphing numerical variables but doesnt clearly show outliers.
...
The distribution of arrival delays are skewed to the right, with some outliers between 150-300.  Arrival delay mean is 1.5 wit majority being under 100.  It seems that these dalays may in fact be on time.
...
The visualization makes it easier to identify the distribution among the data.
