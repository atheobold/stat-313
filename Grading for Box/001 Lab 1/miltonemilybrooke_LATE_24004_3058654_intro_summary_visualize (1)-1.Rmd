...
<!-- Your response goes below this line! -->
yes. carrier, 2 letter abbreviation; tailnum; origin, abbreviation of airport; destination, abbreviation of airport
...
the second graph has less tiers than the first. when the bandwidth becomes larger, we lose exact data points making our data more of a generalization.
...
<!-- Your response goes below this line! -->
a) a scatterplot or boxplot b)the scatterplot often overlaps, making it hard to see specific points; a boxplot includes outliers more so we see a broader overlap
...
The arrival delay mean is 1.465, and a majority of the arrival delays are less than 100. The mean of the data is negative 6 implying that many of te arrival delays are actually not delays at all.
...
It makes it easy to visualize the distribution of means across each month. The graph is a visual reference of the data.
