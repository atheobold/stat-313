...
<!-- Your response goes below this line! -->
Yes. year:numerical, month:numerical, day:numerical, carrier:character, origin:character, dest:character
...
The second and third histograms differ the most due to the second having a bandwidth of 15 and the third having a bandwidth of 150. The first graph falls in between these two bandwidths. The main differences in these histographs due to the differing bandwidths is the visibility of the peaks. It is clear in the third graph (n=150) that there is a trend of departure delays at a low period of time, but it unclear exactly where that peak is located. With a smaller bandwidth, it is easier to see and determine where peaks are located in the data.
...
<!-- Your response goes below this line! -->
a- bar graph, line graph, dot plot, pie chart
b- Histograms allow us to see trends and the distribution of the data. Unfortunately, histograms can be misleading due to the fact that multiple histograms of the same data can look different due to bin width. 
...
It is easier to visualize the distribution of means.
