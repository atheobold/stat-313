...
This data contains 32,735 rows and 16 columns.


1. (b) When were these data collected? 
<!-- Your response goes below this line! -->
This flight data was collected from the year 2013.


1. (c) Are there categorical variables in the dataset? If so, what are their names and data types? 
<!-- Your response goes below this line! -->
Categorical variables in this data set include carrier, 2 letter abbreviation; tailnum; origin, abbreviation of airport; destination, abbreviation of airport.
...
When looking a the graphs the second one seems a lot thinner with less tiers compared to the other graphs. The graphs with larger bars are more generalized and lose exact data points. 
...
<!-- Your response goes below this line! -->
(a) We could have produced a boxplot or scatterplot. 
(b)Histograms allow you to easliy compare data  but can present data that may seem misleading. A boxplot includes outliers and a scatter plot can overlap data making it hard to identify specific points within the graph.
...
By looking at the distribution it can be seen that most of the arrivals fall below 100. The mean of the distribution is negative six showing there is a poor relationship between arrivals and delays. 
...
Using a dot plot allows for easy visualization of the flight distribution of means by each month.
