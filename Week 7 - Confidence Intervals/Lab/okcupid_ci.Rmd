---
title: "Lab 4: Confidence Intervals and OkCupid"
...
```{r faceted-histogram}
# Code for faceted histograms of height
...
__5. Generate a bootstrap distribution of differences in means from 500 bootstrap resamples.__

```{r boot-dist, cache = TRUE}
# Code to generate bootstrap distribution
...
__6. Use the `visualize()` function to create a simple histogram of your 500 bootstrap statistics.__
...
# Code to obtain a 80% percentile based confidence interval
