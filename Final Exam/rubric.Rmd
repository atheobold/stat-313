...
the first question comes from the "statistical inference" bank and the second
question comes from the "linear models" bank. Note that the "statistical 
inference" question is weighed more heavily than the "other topics" question. 
