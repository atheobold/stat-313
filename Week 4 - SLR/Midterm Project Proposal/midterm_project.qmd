...
<!-- Describe the context of your dataset in your own words! How were the data collected? Where did you retreive the data from? Describe at least three variables you are interested in. Choose one variable for the response and at least two explanatory variables. -->
...
## Modeling the Linear Relationship Between <INSERT NAME OF RESPONSE VARIABLE> and <INSERT NAME OF EXPLANATORY VARIABLE>
...
### Model Interpretations for the Slope

<!-- Here is where you describe the decision for the hypothesis test for whether the slope is 0.  -->

<!-- Here is where you interpret the confidence interval for the true slope. -->
