...
::: {style="font-size: 2em; color: #FFFFFF;"}
How did R calculate the p-value?
:::
...
In general, when the conditions associated with a using theoretical methods are violated, these formulas will underestimate the true standard error of the sampling distribution.
