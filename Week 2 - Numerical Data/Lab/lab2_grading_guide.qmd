...
- I'd write a comment if they left in the `n = n()` calculation, since it wasn't requested.
...
- If they didn't calculate one of the four statistics
...
*Feedback:* For Question 6, you were asked to give your visualization nice axis labels. 

- Doesn't include units (minutes) in axis label

*Feedback:* For Question 6, it is important for the axis label to contain the units of the variable. What units were the arrival delays measured in?
...
*Feedback:* For Question 6, what can you *see* in the visualization that was not apparent from the data summaries?
