...
One of the variables refers to the destination (i.e. airport) of the flight,
which have three letter abbreviations. For example, flights into Los 
Angeles have a `dest` of `"LAX"`, flights into San Francisco have a `dest` of
`"SFO"`, and flights into Chicago (O'Hare) have a `dest` of `"ORD"`. 
...
departure delays. Be sure to give your visualization nice axis labels!
