...
`r emo::ji("book")` [**Required Reading:** Basic Regression](https://moderndive.com/5-regression.html)
...
Use the regression table to write out the estimated regression line. 
...
8. What criteria does `R` use to decide what constitutes the "best" regression line?
How is this criteria calculated (mathematically)?
...
5. What `geom_` adds a linear regression trend line to a scatterplot? 
...
Record your response to this week's think out loud prompt, exploring a key concept from the content covered during Week 2. You will be limited to 2 minutes and 30 seconds, to give you an idea of about how long you will have to describe your thinking in an oral exam. 
